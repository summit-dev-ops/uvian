...
class ConversationRepository:
    ...
    async def add_conversation_member(self, membership_data: Dict[str, Any]) -> bool:
    ...
    async def remove_conversation_member(self, conversation_id: str, user_id: str) -> bool:
